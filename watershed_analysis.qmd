...
tc_watershed <- tc_watershed %>%
  mutate(hover_label = "Trout Creek Watershed")

tc_point <- tc_point %>%
  mutate(hover_label = "USGS Stream Gauge 10336790")

tmap_mode("view")

tc_map <- tm_shape(tc_watershed, group = "Watershed") +
  tm_polygons(
    col = "#377eb8",
    alpha = 0.4,
    border.col = "#377eb8",
  ...
  tm_shape(tc_point, group = "USGS Gauge") +
  tm_dots(
    col = "#08306B",
    size = 1,
    id = "hover_label",
